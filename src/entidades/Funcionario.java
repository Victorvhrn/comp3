...
public class Funcionario extends Consumidor{
	...
	public Funcionario(int id,String nome, int matricula, int anoIngresso, Sexo sexo, Titulo titulo, CPF cpf, Departamento departamento) throws NomeNotFoundException {
