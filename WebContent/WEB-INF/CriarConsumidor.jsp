...
<body>
	...
	<tr>
	<% Collection<Departamento> departamento = (Collection<Departamento>) request.getAttribute("departamento");
	...
	<%} %>
	<%Collection<Curso> cursos = (Collection<Curso>) request.getAttribute("curso"); 
